...
const createUsersFromConsulPagos = async(createUsersFromConsulPagos) => {
    ...
    try{
        ...
        .query('INSERT INTO eePoliza_ConsulPago (id_compra, fregistro, producto, poliza, cobertura, tipo_doc, doc_identidad, nombre, apellido, estado, ciudad, municipio, direccion, fnacimiento, sexo, telefono, correo, tipo_pago, banco, telefono_pagador, tipo_doc_pagador, doc_identidad_pagador, sumaaseg, prima, referencia, marca, modelo, version, tipo, cano, placa, serial_carroceria, serial_motor, color, vendedor, tipo_doc_vendedor, doc_identidad_vendedor, telefono_vendedor, correo_vendedor, cplan_rc, fdesde_pol, fhasta_pol) VALUES (@id_compra, @fregistro, @producto, @poliza, @cobertura, @tipo_doc, @doc_identidad, @nombre, @apellido, @estado, @ciudad, @municipio, @direccion, @fnacimiento, @sexo, @telefono, @correo, @tipo_pago, @banco, @telefono_pagador, @tipo_doc_pagador, @doc_identidad_pagador, @sumaaseg, @prima, @referencia, @marca, @modelo, @version, @tipo, @cano, @placa, @serial_carroceria, @serial_motor, @color, @vendedor, @tipo_doc_vendedor, @doc_identidad_vendedor, @telefono_vendedor, @correo_vendedor, @cplan_rc, @fdesde_pol, @fhasta_pol)')
